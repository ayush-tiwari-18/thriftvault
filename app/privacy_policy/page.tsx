...
const page = () => {
  return (
    <div>
      Privacy Policy
 Introduction
This Privacy Policy describes how 8178308335 and its affiliates (collectively "8178308335, we, our, us")
collect, use, share, protect or otherwise process your information/ personal data through our website
https://thriftvault.vercel.app (hereinafter referred to as Platform). Please note that you may be able to
...
any information. If you receive an email, a call from a person/association claiming to be 8178308335
